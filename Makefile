...
download:
	...
	cd $(TMP_DIR)opencv
	cp -r $(shell pwd)/opencv/opencv.zip $(TMP_DIR)opencv 
	unzip -q $(TMP_DIR)opencv/opencv.zip
	cp -r $(shell pwd)/opencv_contrib/opencv_contrib.zip $(TMP_DIR)opencv
	unzip -q $(TMP_DIR)opencv/opencv_contrib.zip
